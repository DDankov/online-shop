        ...
        <tbody>
            {
                ...
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                    ...
                    <Link to={`/seller/dashboard/edit-product/32`} className='p-[6px] bg-yellow-500 rounded hover:shadow-lg hover:shadow-yellow-500/50'> <FaEdit/> </Link>                     <Link className='p-[6px] bg-green-500 rounded hover:shadow-lg hover:shadow-green-500/50'> <FaEye/> </Link>
