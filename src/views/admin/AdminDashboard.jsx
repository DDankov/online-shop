        ...
        <div className='px-2 md:px-7 py-5'>
            ...
            <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7'>
                ...
                <div className='flex justify-between items-center p-5 bg-[#fae8e8] rounded-md gap-3'>
                    ...
                    <MdCurrencyExchange className='text-red-500 text-2xl' />
                </div>
                ...
                <div className='flex justify-between items-center p-5 bg-[#fde2ff] rounded-md gap-3'>
                    ...
                    <MdProductionQuantityLimits className='text-purple-600 text-2xl' />
                </div>
                        ...
                        <div className='flex flex-col gap-2 pt-6 text-[#d0d2d6]'>
                            ...
                            <ol className='relative border-l border-slate-600 ml-4'>
                                ...
                                <li className='mb-3 ml-6'>
                                    <div className='flex absolute -left-5 justify-center items-center w-10 h-10 p-[6px] bg-[#4c7fe2] rounded-full z-10'>
                                        <img
                                    ...
                                    <div className='p-3 bg-slate-800 rounded-lg border border-slate-600'>
                                        <div className='flex justify-between items-center mb-2'>
                                            ...
                                            <time className='text-sm'>2 days ago</time>
                                        </div>
                                        <div className='p-2 text-xs bg-slate-700 rounded-lg'>
                                            How Are you
                                        </div>
                                    </div>
                                </li>
