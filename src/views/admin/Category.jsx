...
const Category = () => {
    ...
    const [pеrPage, setPеrPage] = useState(5)
        ...
        <div className='px-2 lg:px-7 pt-5'>
            <div className='flex flex-wrap w-full'>
                ...
                <div className='flex justify-between items-center'>
                    <select onChange={(e) => setPеrPage(parseInt(e.target.value))} className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]'>
